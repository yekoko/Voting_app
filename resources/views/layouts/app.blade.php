            ...
            <div class="w-70 mx-auto md:mx-0 md:mr-5">
                 <div class="addidea-container md:sticky md:top-8 bg-white border-2 border-blue rounded-xl mt-16">
                     ...
                     <form action="#" method="POST" class="space-y-4 px-4 py-6">
                         ...
                         <div>
                             <textarea name="idea" id="idea" cols="30" rows="4" class="w-full bg-gray-100 border-none rounded-xl placeholder-gray-900 text-sm px-4 py-2" placeholder="Description your idea"></textarea>
                         </div>
