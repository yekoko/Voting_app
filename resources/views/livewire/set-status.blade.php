        ...
        <form wire:submit.prevent="setStatus" action="#" class="space-y-4 px-4 py-6">
            <div class="space-y-2">
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model='status' type="radio" class="bg-gray-200 text-purple border-none" name="status" value="1">
                        <span class="ml-2">Open</span>
                    </label>
                </div>
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model='status' type="radio" class="bg-gray-200 text-blue border-none" name="status" value="2">
            ...
            <div class="flex items-center space-x-3">
                <button 
                 ...
                 <button 
                    type="submit" 
                    class="flex items-center justify-center w-36 h-9 text-xs text-white bg-blue font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 disabled:opacity-50">
                     Update
                </button>
            </div>
            <div>
